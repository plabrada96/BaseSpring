...
@Service
@Transactional
public abstract class GenericRepositoryImpl<T extends GenericEntity, ID extends Serializable>
		implements IGenericService<T, ID> {

	private IGenericRepository<T, ID> abstractBaseRepository;

	@Autowired
	public GenericRepositoryImpl(IGenericRepository<T, ID> abstractBaseRepository) {
